...
<head>
    <title>Chỉnh sửa loại sản phẩm | Quản trị Admin</title>
    <meta charset="utf-8">
...
<main class="app-content">
    <div class="app-title">
        <ul class="app-breadcrumb breadcrumb">
            ...
            <li class="breadcrumb-item"><a>Chỉnh sửa danh mục</a></li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="tile-body">
                    <form class="row" role="form" role="form" action="edit" method="post">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input class="form-control" type="text" name="id" value="${category.id}" required>
                        </div>
                        <div class="form-group col-md-4">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <%--                            <input class="form-control" type="number" name="status" value="${category.status}" required>--%>
                            <select class="form-control" name="status" value="${category.status}" required>
